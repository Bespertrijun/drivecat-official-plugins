;(function () {
  ...
  function renderUploads(data) {
    ...
    overlay.style.cssText = 'position:absolute;top:0;left:0;right:0;bottom:0;z-index:1;cursor:pointer;touch-action:none;background:rgba(0,0,0,0.01);will-change:transform;-webkit-tap-highlight-color:transparent;'
  ...
  function renderQuotas(data) {
    ...
    barOverlay.style.cssText = 'position:absolute;top:0;left:0;right:0;bottom:0;z-index:1;cursor:pointer;touch-action:none;background:rgba(0,0,0,0.01);will-change:transform;-webkit-tap-highlight-color:transparent;'
